...
/**
 * @brief Implementa a isoterma de Elovich para adsorção.
 * 
 * A isoterma de Elovich é uma equação usada para descrever o processo de adsorção em função da concentração do soluto. 
 * Ela utiliza dois parâmetros, \f$ K_1 \f$ e \f$ q_{max} \f$, e suas fórmulas são as seguintes:
 * 
 * \f[
 * Q_e (C_e) = q_{max} \theta
 * \f]
